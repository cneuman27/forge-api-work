...
export class UnitViewerComponent
{
    constructor(private _getUnitService: GetUnitService)
    {
    }
    ...
    private loadUnitStart()
    {
        ...
        this._viewer.loadURN(
            "urn:dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6amNpX21vbV9mb3JnZV90ZXN0L2VtcHR5X21vZGVsLmlwdA",
            () => this.loadUnit());
    }
